        ...
        <div className="flex flex-col lg:flex-row p-6 rounded-lg shadow-lg">
          ...
          <div className="lg:flex-1 p-2 mx-auto items-end">
            ...
            <LazyLoad height={200} offset={100} once>
              <img src={`${product.img1}`} className="lg:w-28 lg:h-28 object-fit rounded-lg cursor-pointer" onClick={() => handleImageClick(product.img1)} />
              </LazyLoad>
              <LazyLoad height={200} offset={100} once>
              <img src={`${product.img2}`} className="lg:w-28 lg:h-28  object-cover rounded-lg cursor-pointer" onClick={() => handleImageClick(product.img2)} />
              </LazyLoad>
               <LazyLoad height={200} offset={100} once>
              <img src={`${product.img3}`} className="lg:w-28 lg:h-28  object-cover rounded-lg cursor-pointer" onClick={() => handleImageClick(product.img3)} />
              </LazyLoad>
              <LazyLoad height={200} offset={100} once>
              <img src={`${product.img4}`} className="lg:w-28 lg:h-28  object-cover rounded-lg cursor-pointer" onClick={() => handleImageClick(product.img4)} />
              </LazyLoad>
            </div>
